...
namespace Game5
{
    internal class Stage5 : Form
    {
        public SoundPlayer stage5SoundPlayer = new SoundPlayer("HoloCure - Shijoshugi Adtruck.wav");
        ...
        public Stage5()
        {
            ...
            do
            {
                playerSkills.SelectedPlayerSkill2 = playerSkills.GetPlayerSelectedSkill();
                Console.WriteLine(selectedplayerSkill2);

                using (StreamWriter writer = new StreamWriter("Skill2.txt"))
                {
                    writer.WriteLine(playerSkills.SelectedPlayerSkill2);
                }
                if (playerSkills.SelectedPlayerSkill == playerSkills.SelectedPlayerSkill2)
                {
                    MessageBox.Show("Try again. Skills already chosen.");
                }
            } while (playerSkills.SelectedPlayerSkill == playerSkills.SelectedPlayerSkill2);
        ...
        public void StartWave(int wave)
        {
            if (gameOver == false)
            {
                ...
                {
                    case 1:
                        totalEnemiesToSpawn = 4; // Change to the total number of enemies you want in wave 1
                        break;
                    case 2:
        ...
        private void SpawnWave1()
        {
            if (EnemiesSpawned < totalEnemiesToSpawn && gameOver == false)
            {
                if (gameStopWatch.ElapsedMilliseconds >= nextAddEnemy)
                {
                    ...
                    {
                        enemyCreated = enemy.CreateEnemy(newX, newY + 75, hp = 9, "Type2", 1, 1, goUp, mobSize);
                        newY += 150;
                        //enemyCreated = enemy.CreateEnemy(newX, player.Location.Y, hp = 1000, "Type4", 1, 1, goUp, mobSize);
        ...
        private void SpawnWave2()
        {
            if (EnemiesSpawned < totalEnemiesToSpawn && gameOver == false)
            {
                if (EnemiesSpawned < 10 && EnemiesSpawned % 2 == 0)
                {
                    enemyCreated = enemy.CreateEnemy(newX, 10, hp = 20, "Type1", tag = 1, 1, goUp, mobSize);
                    nextAddEnemy = gameStopWatch.ElapsedMilliseconds + 500;
                }
                else if (EnemiesSpawned < 10 && EnemiesSpawned % 2 == 1)
                {
                    enemyCreated = enemy.CreateEnemy(newX, 710, hp = 20, "Type1", tag = 2, 1, goUp, mobSize);
                    nextAddEnemy = gameStopWatch.ElapsedMilliseconds + 500;
                }
        ...
        private void SpawnWave3()
        {
            if (EnemiesSpawned < totalEnemiesToSpawn && gameOver == false)
            {
                ...
                if (gameStopWatch.ElapsedMilliseconds >= nextAddEnemy)
                {
                    ...
                    {
                        enemyCreated = enemy.CreateEnemy(newX, 700, hp = 3, "Type1", 2, 1, goUp, mobSize); ;
                    }
        ...
        private void SpawnWave5()
        {
            if (EnemiesSpawned < totalEnemiesToSpawn && gameOver == false)
            {
                ...
                if (gameStopWatch.ElapsedMilliseconds >= nextAddEnemy)
                {
                    ...
                    if (EnemiesSpawned < 10 && EnemiesSpawned % 2 == 1)
                    {
                        enemyCreated = enemy.CreateEnemy(newX, player.Location.Y, hp = 150, "Type4", 2, 5, goUp, mobSize);
                    }
                    else if (EnemiesSpawned < 10 && EnemiesSpawned % 2 == 0)
                    {
